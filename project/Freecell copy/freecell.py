...
class freecell:
    ...
    def __str__(self):
        move = "input 'm <space> <main> <space> <target>'the last card of a column within a cascade"
        free = "input 'f <space> <target>' to move the last card in the target column to the freecells"
        foundations = "input 's <space> <target>' to sort the last card in the target column to the foundation"
        unfree = "input 'u <space> <freecell target> <space><cascade target>' to move the card from the freecells" \
                 "to the cascade or to the foundation"
        quiting = "input QUIT in uppercase to quit the game"
        instruction = '\n'+'HOW TO PLAY:'+'\n' + move +'\n'+ free+ '\n' + foundations +'\n'+ unfree + '\n'\
                      + quiting +'\n'*2
